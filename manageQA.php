...
<body style="background-color: azure;">
    ...
    <?php
        ...
        if (isset($_POST['delete'])) {
            ...
            // Execute the SQL query
            $result = mysqli_query($connection ,"DELETE FROM qa WHERE QA_Id = $id");
...
<h1 style="color:black; font-family: Times New Roman; text-align: center;">Control Panel For Manage QA</h1>
...
<table class="data-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <?php echo $row["answer_4"]; ?> </td>
            <td> <?php echo $row["correct_answer"]; ?> </td>
            <td> <?php echo $row["level"]; ?> </td>

            <td>
                <form method="post" class="action-form" style="display: inline-block;">
                    <input type="hidden" name="id" value="<?php echo $row["QA_Id"]; ?>">
                    <button type="submit" name="delete" class="form-btn">Delete</button>
                </form>
                <form method="post" action="./updateQA.php" class="action-form" style="display: inline-block;">
                    <input type="hidden" name="id" value="<?php echo $row["QA_Id"]; ?>">
